...
const components = {
    ...
    'CasesFeedSection': dynamic(() => import('./sections/CasesFeedSection')),
    'TestimonialsFeedSection': dynamic(() => import('./sections/TestimonialsFeedSection')),
    'FeaturedPostsSection': dynamic(() => import('./sections/FeaturedPostsSection')),
    'FeaturedCasesSection': dynamic(() => import('./sections/FeaturedCasesSection')),
    'FeaturedTestimonialsSection': dynamic(() => import('./sections/FeaturedTestimonialsSection')),
    ...
    'TestimonialsLayout': dynamic(() => import('./layouts/TestimonialsLayout')),
    'PostFeedLayout': dynamic(() => import('./layouts/PostFeedLayout')),
    'CasesFeedLayout': dynamic(() => import('./layouts/CasesFeedLayout')),
    'TestimonialsFeedLayout': dynamic(() => import('./layouts/TestimonialsFeedLayout')),
