...
hero:
  - type: HeroSection
    ...
    title: >
      ...
      rgba(241,192,47,1);"></span><h1><span></span></h1><span style="font-size:
      2.25rem;"><strong style="font-size: 28px; color: 
      rgba(241,192,47,1);"></strong></span>
    subtitle: >-
...
sections:
  ...
  - colors: colors-b
    ...
    title: |+
      ...
      <strong>Phoenix, Arizona Board-Certified Criminal Law Specialist.</strong>
      </h3>
    ...
    backgroundSize: full
    backgroundImage:
      url: /images/background-arizona-desert.jpg
      backgroundSize: cover
      backgroundPosition: center
      opacity: 100
  - elementId: ''
    ...
    text: >+
      ...
      circumstances similar to yours. Choose us guide you through the criminal
      defense system. There are a lot of criminal defense lawyers in practice,
      ...
      criminal charges by prosecutors at the Arizona state or federal
      level.</p></div>
...
metaTags:
  - type: MetaTag
    property: 'og:type'
    content: website
metaTitle: Criminal Defense Attorney Phoenix  | Blumberg & Associates
metaDescription: >-
