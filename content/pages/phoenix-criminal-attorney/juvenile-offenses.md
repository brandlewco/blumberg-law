...
hero:
  - type: HeroSection
    ...
    actions:
      - type: Button
        label: |
          Confidential Juvenile Crime Case Evaluation
        url: /contact-us/
        style: primary
        iconPosition: right
        icon: arrowRight
    ...
    backgroundImage:
      ...
      opacity: 100
    subtitle: >-
      Our Phoenix juvenile crime attorneys are committed to helping juveniles
      and their families resolve criminal charges in juvenile court.
sections:
  - type: TextSection
    colors: colors-a
    variant: variant-a
      ...
      - type: FeaturedItem
        actions:
          ...
          - type: Button
            ...
            altText: Parole & Probation Violations
