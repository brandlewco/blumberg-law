...
hero:
  - type: HeroSection
    ...
    actions:
      - type: Button
        label: |
          Confidential Homicide Case Evaluation
        url: /contact-us/
        style: primary
        iconPosition: right
        icon: arrowRight
    ...
    backgroundImage:
      ...
      opacity: 100
    subtitle: >-
      Phoenix homicide defense attorney Bruce Blumberg can help put together a
      not guilty case for your homicide arrest in Arizona, especially violent
      murder cases.
    media:
      type: ImageBlock
